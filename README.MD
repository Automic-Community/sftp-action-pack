...
###### Description
 ...
 This action pack enables you to download files via SFTP.
...
Please refer to the link for [package documentation](source/ae/DOCUMENTATION/PCK.AUTOMIC_SFTP.PUB.DOC.xml)
